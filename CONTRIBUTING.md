...
**1.** Fork [this](https://github.com/twimbit/OpenDash) repository.

**2.** Clone the forked repository.

```terminal
git clone https://github.com/<your-github-username>/OpenDash.git
```
...
**9.** **Congratulations!** Sit and relax, you've made your contribution to the [OpenDash](https://github.com/twimbit/OpenDash) project.
