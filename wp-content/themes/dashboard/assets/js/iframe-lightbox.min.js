!(function(s, o) {
  ...
  var n = o.documentElement || "",
    ...
    m =
      ...
      void 0 !== o.createTouch ||
      "ontouchstart" in s ||
      "onmsgesturechange" in s ||
      navigator.msMaxTouchPoints,
    i = function(t, e) {
      var i = e || {};
      (this.trigger = t),
        (this.el = o.getElementsByClassName(l)[0] || ""),
        ...
        (this.rate = i.rate || 500),
        (this.scrolling = i.scrolling),
        (this.touch = i.touch),
        (this.onOpened = i.onOpened),
        (this.onIframeLoaded = i.onIframeLoaded),
        (this.onLoaded = i.onLoaded),
        (this.onCreated = i.onCreated),
        (this.onClosed = i.onClosed),
        this.init();
    };
  (i.prototype.init = function() {
    ...
    this.trigger.classList.contains(r) ||
    ...
    (i.prototype.create = function() {
      ...
      t.classList.add("backdrop"),
        ...
        (this.body = o.createElement("div")),
        this.body.classList.add("body"),
        this.content.appendChild(this.body),
        (this.contentHolder = o.createElement("div")),
        this.contentHolder.classList.add("content-holder"),
        this.contentHolder.appendChild(this.content),
        this.el.appendChild(this.contentHolder),
        (this.btnClose = o.createElement("a")),
      ...
      this.el.addEventListener("transitionend", i, !1),
        this.el.addEventListener("webkitTransitionEnd", i, !1),
        this.el.addEventListener("mozTransitionEnd", i, !1),
        this.el.addEventListener("msTransitionEnd", i, !1),
        this.callCallback(this.onCreated, this);
    }),
    (i.prototype.loadIframe = function() {
      var t = this;
      (this.iframeId = l + Date.now()),
      ...
      n.push(
        ...
        (e = this.iframeId),
        (i = this.body),
        ((s = o.getElementById(e)).onload = function() {
